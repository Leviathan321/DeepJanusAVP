...
class ScenarioGenerator:
    ...
    def generate(self, visualise=False) -> AVPMember:
        # TODO
        config = AVPConfig
        sc_member = AVPMember(orientation_ped= 
                            random.random() * (config.MAX_PED_ORIENTATION - config.MIN_PED_ORIENTATION),
                            velocity_ego= 
                            random.random() * (config.MAX_SPEED),
                            velocity_ped=
                            random.random() * (config.MAX_SPEED))
