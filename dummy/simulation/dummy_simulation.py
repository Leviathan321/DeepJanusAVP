...
from dummy.simulation.simulator import Simulator, SimulationOutput
from math import sin, cos, pi, ceil
import numpy as np
from random import random
from dummy.utils.geometric import *
import dummy.utils.geometric as geometric
import json
...
class DummySimulator(Simulator):
    ...
    def simulate_single(vars, 
        ...
        egoInitialVelocity = vars[0]
        pedInitialVelocity = vars[1]
        egoOrientation = 90 #vars[0]
        pedOrientation = vars[2]
        start_pos_ped = [50, 20] # should be also defined by input parameter
        start_pos_ego = [20, 0] # should be also defined by input parameter
